...
#ifndef VERILATED_VNTT_FULL_H_
#define VERILATED_VNTT_FULL_H_  // guard

#include "verilated.h"

class Vntt_full__Syms;
class Vntt_full___024root;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) Vntt_full VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    Vntt_full___024root* const rootp;
    ...
    explicit Vntt_full(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vntt_full(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vntt_full();
  private:
    VL_UNCOPYABLE(Vntt_full);  ///< Copying not allowed
