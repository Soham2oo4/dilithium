...
#endif
            VL_FATAL_MT("ntt_full.v", 2, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("ntt_full.v", 2, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("ntt_full.v", 2, "", "Active region did not converge.");
            }
