...
#ifndef VERILATED_VINTT_FULL_H_
#define VERILATED_VINTT_FULL_H_  // guard

#include "verilated.h"

class Vintt_full__Syms;
class Vintt_full___024root;
class VerilatedVcdC;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) Vintt_full VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    Vintt_full___024root* const rootp;
    ...
    explicit Vintt_full(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vintt_full(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vintt_full();
  private:
    VL_UNCOPYABLE(Vintt_full);  ///< Copying not allowed
